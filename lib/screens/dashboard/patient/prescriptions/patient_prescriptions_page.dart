...
import '../widgets/patient_prescription_details_modal.dart';
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final String diagnosis = (data['diagnosis'] ?? 'Clinical Consultation').toString();
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    const Icon(Icons.medication_rounded, size: 15, color: Color(0xFF0EA5E9)),
